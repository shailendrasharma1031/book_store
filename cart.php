...
<body>
<div class="wrap cf">
  <h1 class="projTitle">Online Book Store</h1>
  <div class="heading cf">
    <h1>My Cart</h1>
    <a href="tourIndex.php" class="continue">Continue Shopping</a>
  </div>
  <div class="cart">
<!--    <ul class="tableHead">
...
$b=$_GET['bid'];
$c=$_GET['cid'];
$sql="DELETE FROM history WHERE bid= '$b' AND cid = '$c'";
$result1 = $conn->query($sql);

}

$sql="select bid,cid,qty from history where cid='$id'";
    ...
    <div class="infoWrap"> 
        <div class="cartSection">
          ...
          <h3>'.$name.'</h3>
           ...
           <p> <input type="text"  class="qty" placeholder="1"/> x Rs.'.$price.'</p>
...
echo '</ul>
  ...
  <div class="subtotal cf">
    <ul>
      <li class="totalRow"><span class="label">Subtotal</span><span class="value">'.$tot.'</span></li>
      
          <li class="totalRow"><span class="label">Shipping</span><span class="value">50</span></li>
      ...
      <li class="totalRow"><a href="Address.php" class="btn continue">Checkout</a></li>
    </ul>
  </div>
</div>';
?>
